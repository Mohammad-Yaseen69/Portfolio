...
const Hero = () => {
  ...
  const resume = useSelector(state => state.info.resume)
    ...
    <Section className="">
      <div ref={ref} className='relative content flex items-center opacity-0 pb-40 md:pb-56  justify-center h-screen  px-9'>
        <div className='flex flex-col gap-4 items-center'>
          ...
          <a href={resume} download="Mohammad_Yaseen_CV.pdf">  <button className='button max-xs:p-[0.3em]'>Download CV</button></a>
        </div>
      </div>
    </Section>
  )
